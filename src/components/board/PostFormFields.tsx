    ...
    <>
      ...
      <div>
        <div className="flex justify-between items-center mb-1.5 xs:mb-2">
          ...
          <span className={`text-xs xs:text-sm ${title.length > maxTitleLength ? 'text-red-500' : 'text-gray-500'}`}>
        ...
        <input
          ...
          {...register('title', {
            ...
            maxLength: { value: maxTitleLength, message: `제목은 ${maxTitleLength}자 이하여야 합니다` },
          })}
          className="w-full px-3 xs:px-4 py-2 xs:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm xs:text-base"
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          ...
          <span className={`text-xs xs:text-sm ${content.length > maxContentLength ? 'text-red-500' : 'text-gray-500'}`}>
        ...
        <textarea
          ...
          {...register('content', {
            ...
            maxLength: { value: maxContentLength, message: `내용은 ${maxContentLength}자 이하여야 합니다` },
          })}
          rows={10}
